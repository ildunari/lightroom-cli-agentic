...
_register(
    ...
    CommandSchema(
        ...
        "catalog.find-brackets",
        "Find likely exposure-bracketed photo groups",
        params=[
            ParamSchema(
                "photoIds",
                ParamType.JSON_ARRAY,
                description="Optional array of photo IDs to inspect",
            ),
            ParamSchema(
                "source",
                ParamType.ENUM,
                default="selected",
                enum_values=["selected", "all"],
            ...
            ParamSchema(
                ...
                ParamType.FLOAT,
                default=2.0,
                description="Maximum capture-time gap between frames in one bracket",
                min=0,
            ),
            ParamSchema(
                "minPhotos",
                ParamType.INTEGER,
                default=3,
                description="Minimum photos and distinct exposure-bias values per bracket",
                min=2,
                max=20,
            ),
            ParamSchema(
                ...
                ParamType.INTEGER,
                default=9,
                description="Maximum photos in one bracket before starting a new group",
                min=2,
                max=20,
            ),
        ],
